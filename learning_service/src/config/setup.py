...
class Settings(BaseSettings):
    ...
    LEARNING_SERVICE_SERVER_PORT = int(os.environ.get("LEARNING_SERVICE_SERVER_PORT"))
    LEARNING_SERVICE_SERVER_HOST = str(os.environ.get("LEARNING_SERVICE_SERVER_HOST"))
    PG_USERNAME = str(os.environ.get("PG_USERNAME"))
    SSL_MODE = str(os.environ.get("SSL_MODE"))
    PG_PASSWORD = str(os.getenv("PG_PASSWORD"))
    LEARNING_SERVICE_DB = str(os.getenv("LEARNING_SERVICE_DB"))
    BASE_URL = 'https://{}'.format(LEARNING_SERVICE_SERVER_HOST)
    DATABASE_URL = 'postgres://{}:{}@{}/{}'.format(PG_USERNAME, PG_PASSWORD, HOST, LEARNING_SERVICE_DB)
