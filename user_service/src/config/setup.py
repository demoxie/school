...
class Settings(BaseSettings):
    ...
    USER_SERVICE_SERVER_PORT = int(os.environ.get("USER_SERVICE_SERVER_PORT"))
    USER_SERVICE_SERVER_HOST = str(os.environ.get("USER_SERVICE_SERVER_HOST"))
    PG_USERNAME = str(os.environ.get("PG_USERNAME"))
    SSL_MODE = str(os.environ.get("SSL_MODE"))
    PG_PASSWORD = str(os.getenv("PG_PASSWORD"))
    USER_SERVICE_DB = str(os.getenv("USER_SERVICE_DB"))
    BASE_URL = 'https://{}'.format(USER_SERVICE_SERVER_HOST)
    DATABASE_URL = 'postgres://{}:{}@{}/{}'.format(PG_USERNAME, PG_PASSWORD, HOST, USER_SERVICE_DB)
